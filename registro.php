...
if (isset($_POST['guardar'])) {  
    ...
    $secret_answer = password_hash($_POST['secret_answer'], PASSWORD_DEFAULT); // Encriptar la respuesta secreta
        ...
        <div class="row align-items-center py-5">
            <div class="col-md-8 text-white">
                ...
                <form action="" method="post">
                    ...
                    <center><button type="submit" name="guardar" class="btn btn-primary">Registrarse</button></center>
                </form>
            </div>
            <div class="col-md-4">
